...
namespace Full_GRASP_And_SOLID
{
    public class Program
    {
        ...
        public static void Main(string[] args)
        {
            ...
            PopulateCatalogs(catalogCreator);
        ...
        private static void PopulateCatalogs(CatalogCreator catalogCreator)
        {
            catalogCreator.CreateProduct("Café", 100);
            catalogCreator.CreateProduct("Leche", 200);
            catalogCreator.CreateProduct("Café con leche", 300);

            catalogCreator.CreateEquipment("Cafetera", 1000);
            catalogCreator.CreateEquipment("Hervidor", 2000);
        }
